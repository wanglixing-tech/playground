...
public class GS1 {
	...
	public String getGrossWeigth() {
		return grossWeigth;
	}
	public void setGrossWeigth(String grossWeigth) {
		this.grossWeigth = grossWeigth;
	}
	public String getGrossWeigthUOM() {
		return grossWeigthUOM;
	}
	public void setGrossWeigthUOM(String grossWeigthUOM) {
		this.grossWeigthUOM = grossWeigthUOM;
	}
	...
	public String toString() {
		...
		fmt.format("Gross Weigth = %s%n", this.grossWeigth);
		fmt.format("Gross Weigth UOM = %s%n", this.grossWeigthUOM);
