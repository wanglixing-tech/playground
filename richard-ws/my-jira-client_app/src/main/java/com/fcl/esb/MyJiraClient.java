...
public class MyJiraClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        MyJiraClient myJiraClient = new MyJiraClient("richard.wang@fcl.crs", "XXXXXXXX", "https://fclweb.jira.com");
        ...
        Issue issue = myJiraClient.getIssue("OMS-112");
        ...
        List<Comment> comments = myJiraClient.getAllComments("OMS-112");
