...
public class ScriptRunner {
	...
	public ScriptRunner() throws ClassNotFoundException, SQLException {
	...
	private void executeStatement(String command) throws SQLException {
		...
		try {
	        if ( dbMetaData.getDriverName().contains("SQLite")) {
	            System.out.println("JDBC DRIVER is:" + dbMetaData.getDriverName());	        	
				// setEscapeProcessing() was not implemented by SQLite JDBC Driver
