	...
	{ 
		...
		{ 
			...
			{ 
				...
				{ 
					System.out.println("Project Name:" + element.getData()); 
				} 
				...
				if (isNature) { 
					if (element.getData().equals("com.ibm.etools.msgbroker.tooling.applicationNature")) {
						System.out.println("APP attribute:" + element.getData()); 						
					} else {
						if (element.getData().equals("com.ibm.etools.mft.bar.ext.barnature")) {
							System.out.println("BAR attribute:" + element.getData()); 	
						}
					}
					System.out.println("Other attribute:" + element.getData()); 
				} 
			} 
		} 
	} 
